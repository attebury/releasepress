...
export function runProviderPreflight({
  ...
  try {
    ...
    reviewCommit = reviewReport.reviewed_commit;
  } catch (err) {
...
function runCustomPreflightCheck({ preflight, releaseIdentity, runner, cwd }) {
...
function checkNpmVersionPreflight({ packageName, version, runner, cwd }) {
...
function checkGitTagPreflight({ repo, tagName, runner, cwd }) {
